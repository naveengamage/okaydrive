...
<div class="container">
    ...
    <form method="POST" action="{{ URL::to('password_reset') }}" accept-charset="UTF-8" class="form-signin" style="top: 34px; display: block;">
        ...
        @endif
        <h2 class="form-login-heading" style="font-size:16px; color:#fff; text-align:center; font-weight:normal; margin-bottom:15px; margin-top:5px;">Reset Password</h2>
          
        <input name="email" type="text" id="email" class="form-control" placeholder="Email Address">
        <button class="btn btn-lg btn-block btn-color" type="submit">Submit</button>
